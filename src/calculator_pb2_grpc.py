...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                ...
                response_deserializer=calculator__pb2.CalculationReply.FromString,
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Add': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=calculator__pb2.CalculationReply.SerializeToString,
            ),
...
class Calculator(object):
    ...
    def Add(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            calculator__pb2.CalculationReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
